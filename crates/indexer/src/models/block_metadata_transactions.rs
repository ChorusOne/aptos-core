...
use anyhow::Context;
use aptos_api_types::{BlockMetadataTransaction as APIBlockMetadataTransaction, Event as APIEvent};
...
impl BlockMetadataTransaction {
    ...
    fn get_block_height_from_events(events: &[APIEvent], txn_version: i64) -> anyhow::Result<i64> {
        for event in events {
